...
public class BufMgr implements GlobalConst{
  ...
  /** Call DB object to allocate a run of new pages and ufmgr.BufMgrException: BUFMNG: BUFFER_EXCEED.
	at bufmgr.BufMgr.newPage(BufMgr.java:662)
	at tests.BMDriver.test1(BMTest2.java:172)
	at tests.BMDriver.runAllTests(BMTest2.java:114)
	at tests.BMDriver.runTests(BMTest2.java:88)
	at tests.BMTest.main(BMTest.java:639)
  ...
  public PageId newPage(Page firstpage, int howmany)
   ...
   { 
     int  i;
	/*if(howmany>numBuffers) {
		throw new BufMgrException(null, "BUFMNG: BUFFER_EXCEED.");
	}*/
